...
<c:forEach var="template" items="${requestScope.templates}">
    <c:set var="revenue" value="${revenue + template.price}" />
</c:forEach>
                            ...
                            <thead>
                                <tr class="edd_cart_header_row">
                                    ...
                                    <th class="edd_cart_item_price">
                                        Price ($<fmt:formatNumber value="${revenue}" minFractionDigits="2" maxFractionDigits="2"/>)
                                    </th>
                            ...
                            <tbody>
                                <c:forEach var="template" items="${requestScope.templates}" varStatus="loop">
                                    <tr class="edd_cart_item" >
                                        ...
                                        <td>
                                            ${requestScope.buyers.get(loop.index).getUsername()}
                                        </td>
                                        <td>
                                            ${requestScope.buyers.get(loop.index).getEmail()}
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
