            ...
            <div class="container toparea">
                ...
                <div id="edd_checkout_wrap" class="col-md-8 col-md-offset-2">
                    ...
                    <div style="margin-bottom: 10px;">
                        ...
                        <div style="width: 50%; display: inline-block;"><a style="padding-left: 20%;" href="${pageContext.request.contextPath}/Template/listing"><button class="edd-submit button">Continue Shopping</button></a></div>
                        <div style="width: 50%; display: inline-block; float: right;"><a style="padding-left: 20%" href="${pageContext.request.contextPath}/Cart/checkout"><button class="edd-submit button">Check out</button></a></div>
